...
'''
# db_setup.py - Estrutura inicial do banco de dados do sistema GyroAI-SAT
...
def create_db():
    ...
    # Tabela 5 - Dados Orbitais
    cursor.execute("""
        CREATE TABLE IF NOT EXISTS dados_orbitais (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            sim_id INTEGER,
            tempo REAL,
            x_km REAL, y_km REAL, z_km REAL,
            vx_km_s REAL, vy_km_s REAL, vz_km_s REAL,
...
# Executa a criação se rodar como script
